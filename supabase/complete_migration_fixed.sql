-- SCRIPT MIGRASI BKPOS V.10.4 (FIXED)
...
BEGIN
    ...
    -- Recreate view with new category structure
    ...
    -- Create process_return function
    ...
    -- Create distribute_stock_bulk function
    ...
    DROP TRIGGER IF EXISTS update_sku_counter_updated_at ON sku_counter;
