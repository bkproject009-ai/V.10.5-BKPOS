-- Update the function with correct column name
...
-- Make sure the cashier_stock table has a unique constraint
alter table cashier_stock 
drop constraint if exists cashier_stock_product_cashier_unique;
